...
from models.CRUD_on_car.vehicles_model import Car

def test_new_vehicle():
    """
    GIVEN a Car model
    WHEN a new Car is created
    THEN check the vehicle id, the model name, number of seat,
    features, and the make name. Assert that they are defined correctly
    """
    car = Car(1234, 'Batmobile', 2, "throws explosives", "whatmakesmakes", 2012,
        1,"2024-02-05","2024-03-05", 505, 644, "sunflower seeds","manual", "magenta", "H3H 1K4"  )
